...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_MultiplayerSessions_MultiplayerOnCreateSessionComplete__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// DYNAMIC means that this delegate can be serialized and can be used through blueprints (called event dispatchers)\n// DYNAMIC delegates also require that every function subscribed has UFUNCTION property\n// MULTICAST means that multiple classes can bind their functions to this delegate\n" },
		{ "ModuleRelativePath", "Public/MultiplayerSessionsSubsystem.h" },
		{ "ToolTip", "DYNAMIC means that this delegate can be serialized and can be used through blueprints (called event dispatchers)\nDYNAMIC delegates also require that every function subscribed has UFUNCTION property\nMULTICAST means that multiple classes can bind their functions to this delegate" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_UnrealMPShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealMPShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsSubsystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealMPShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsSubsystem_h_1773940453(TEXT("/Script/MultiplayerSessions"),
		Z_CompiledInDeferFile_FID_UnrealMPShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealMPShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
